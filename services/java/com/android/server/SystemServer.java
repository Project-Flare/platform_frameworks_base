...
import com.android.server.flare.FlareDeviceConfigService;
...
public final class SystemServer implements Dumpable {
    ...
    private void startOtherServices(@NonNull TimingsTraceAndSlog t) {
        ...
        if (mFactoryTestMode == FactoryTest.FACTORY_TEST_LOW_LEVEL) {
            ...
            // FlareDeviceConfigService
            t.traceBegin("StartFlareDeviceConfigService");
            mSystemServiceManager.startService(FlareDeviceConfigService.class);
            t.traceEnd();
